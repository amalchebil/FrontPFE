...
export default function HeaderSiege() {
const navigate= new useNavigate();
  ...
  return (
    ...
    <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a className="navbar-brand brand-logo" href="../../index.html"><img src="../../assets/images/Utss.jpg" alt="logo" style={{height:90,marginTop:60}} /></a>
        ...
        <ul className="navbar-nav navbar-nav-right">
            ...
            <li className="nav-item nav-logout d-none d-lg-block">
                <a className="nav-link" href="#">
                    <i className="mdi mdi-power" onClick={logout} />
                </a>
            </li>
            <li className="nav-item nav-settings d-none d-lg-block">
                <a className="nav-link" >
                    <i className="mdi mdi-account"  onClick={view}/>
                </a>
            </li>
        </ul>
