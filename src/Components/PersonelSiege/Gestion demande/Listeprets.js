...
const Listepret = () => {
    ...
    const handlem = (itemId, id_client, id_demande, type_pret, tranche) => {
        
        const item = []

        setSelectedId(id_client);
        setSelectedIddemande(id_demande)
        setpret(type_pret)
        setTranche(tranche)
        console.log("dd", id_client, type_pret, tranche, id_demande);
        setOpenModal(true);
    }
    ...
    const renderTableRows = () => {
        ...
        return filteredData.slice(startIndex, endIndex).map(row => (
            ...
            <td>    <button
             ...
             <td>   <button
                    onClick={() => handlem(row.id_demande, row.client.id_client, row.id_demande, row.type_pret, row.tranche)}
                ...
                <div className="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Prets</li>
                        </ol>
                    </nav>
                </div>
                <div className="row">
                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">liste prets </h4>
