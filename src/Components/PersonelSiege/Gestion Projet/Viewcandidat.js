                ...
                <div className="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Candidat</li>
                        </ol>
                    </nav>
                </div>
                <div className="row">
                    ...
                    <div className="col-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Détail de candidature projets </h4>
  ...
  <div className="col-md-6">
    <div className="form-group">
      ...
      <input className="form-control" value={cin_c} type="text" name="id" />
                                            ...
                                            <button id="send" type="submit" class="btn btn-gradient-secondary" onClick={(e) => { view(client) }} >transactions du client</button>
