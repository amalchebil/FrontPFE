...
const Liste_demandepretrejeter = () => {
    ...
    const renderedArray = data.filter((item) => {
        if (item.status == "Rejeter" && item.client.agc.id == localStorage.getItem('id_agence')) {
            ...
            <tr key={row.id}>
                ...
                <td>
                    <span onClick={(e) => { viewuserFunction(row.id_demande) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="#FF0000" class="bi bi-eye" viewBox="0 0 16 16">
                    ...
                    <div className="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item">Demandes de prets rejetées</li>
                            </ol>
                        </nav>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-lg-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    <h4 className="card-title">Demandes rejetées</h4>
                                    <div></div>
...
export default Liste_demandepretrejeter;