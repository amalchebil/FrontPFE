                ...
                <div className='modalRight'>
                    ...
                    <div className='content'>
                        <form className="form-horizontal form-label-left" onSubmit={(e) => onSubmit(e)}>
                            <p className='cp'>Remboursement de pret </p><br></br><br></br>

                            <div className="item form-group">
                                <label className="control-label col-md-3 col-sm-3 col-xs-12" htmlFor="name">ID pret <span className="required">*</span>
                                </label>
                                <div className="col-md-6 col-sm-6 col-xs-12">
                                    <input className="form-control col-md-7 col-xs-12" name="name" value={selectedId} type="text" style={{ marginLeft: 150 }}
                            ...
                            <div className="item form-group">
                                ...
                                <div className="col-md-6 col-sm-6 col-xs-12">
                                    <input className="form-control col-md-7 col-xs-12" name="name" onChange={e => setMontant(e.target.value)} placeholder="montant" type="number" style={{ marginLeft: 150 }}
