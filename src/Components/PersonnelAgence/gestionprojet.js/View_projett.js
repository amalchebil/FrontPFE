...
const View_projett = () => {
    ...
    const view = (id) => {
        navigate("/ajouter_candidat/" + id, { state: { id: id } })
                        ...
                        <div className="col-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button id="send" type="submit" className="btn btn-success" style={{ marginLeft: 780 }} onClick={(e) => { view(id) }} >Add candidature</button>
