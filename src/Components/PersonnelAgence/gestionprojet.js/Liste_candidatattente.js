...
const Liste_candidatattente = () => {
    ...
    const viewuserFunction = (id) => {
        navigate("/view_candidatagence/" + id, { state: { id: id } })
    }
        ...
        return newArray.slice(startIndex, endIndex).map(row => (
            <tr key={row.id}>
                ...
                {/* <td> <button
                    ...
                    onClick={(e) => { deleteFunction(row.id_demande) }}
                >
                    ...
                    <div className="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Candidatures</li>
                            </ol>
                        </nav>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-lg-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    <h4 className="card-title">liste candidatures projets en attente</h4>
...
export default Liste_candidatattente;