    ...
    const renderTableRows = () => {
        ...
        return newArray.slice(startIndex, endIndex).map(row => (
            <tr key={row.id}>
                ...
                <td>{row.secteur}</td>
                <td>  <button type="button" class="btn btn-inverse-info btn-fw" style={{ fontSize: 10 }}> {row.statuP}</button></td>
                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">les projets decaissées</h4>
