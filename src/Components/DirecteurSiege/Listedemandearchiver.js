...
const ListedemandeArchiver = () => {
    ...
    const viewuserFunction = (id) => {
        navigate("/view_demande/" + id, { state: { id: id } })
    ...
    const renderTableRows = () => {
        ...
        return filteredData.slice(startIndex, endIndex).map(row => (
            <tr key={row.id}>
                ...
                <td>{row.type_pret}</td>
                <button type="button" class="btn btn-round btn-info" > <td>{row.status}</td></button>
                        ...
                        <div className="col-lg-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    <h4 className="card-title">liste demandes archivées</h4>
...
export default ListedemandeArchiver;